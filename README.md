...
Для бочек, утопленных заподлицо в пол, разрешён подход с соседнего пола и стояние непосредственно над открытой бочкой. Это отдельное правило `BarrelBlock`; ограничения для настенных и верхних сундуков не ослабляются.
